...
urlpatterns = [
    ...
    path('inventory/work-station/scan/machine-parts/', views.work_station_scan_machine_parts, name='work_station_scan_machine_parts'),
    path('inventory/work-station/scan/record-usage/', views.work_station_scan_record_usage, name='work_station_scan_record_usage'),
